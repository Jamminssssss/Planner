...
extension SeasonTheme {
    var diaryDarkBackgroundGradient: LinearGradient {
        switch self {
        case .classic: return LinearGradient(colors: [Color(red: 0.06, green: 0.14, blue: 0.06), Color(red: 0.04, green: 0.10, blue: 0.04)], startPoint: .top, endPoint: .bottom)
        case .spring: return LinearGradient(colors: [Color(red: 0.18, green: 0.06, blue: 0.14), Color(red: 0.12, green: 0.04, blue: 0.10)], startPoint: .top, endPoint: .bottom)
        case .summer: return LinearGradient(colors: [Color(red: 0.04, green: 0.10, blue: 0.22), Color(red: 0.03, green: 0.07, blue: 0.18)], startPoint: .top, endPoint: .bottom)
        case .autumn: return LinearGradient(colors: [Color(red: 0.20, green: 0.10, blue: 0.02), Color(red: 0.15, green: 0.07, blue: 0.01)], startPoint: .top, endPoint: .bottom)
        case .winter: return LinearGradient(colors: [Color(red: 0.06, green: 0.08, blue: 0.18), Color(red: 0.04, green: 0.06, blue: 0.14)], startPoint: .top, endPoint: .bottom)
        }
    }

    var diaryBackgroundGradient: LinearGradient {
        switch self {
        case .classic: return LinearGradient(colors: [Color(red: 0.88, green: 0.95, blue: 0.88), Color(red: 0.76, green: 0.90, blue: 0.76)], startPoint: .top, endPoint: .bottom)
        case .spring: return LinearGradient(colors: [Color(red: 0.99, green: 0.93, blue: 0.97), Color(red: 0.96, green: 0.85, blue: 0.93)], startPoint: .top, endPoint: .bottom)
        case .summer: return LinearGradient(colors: [Color(red: 0.87, green: 0.95, blue: 1.00), Color(red: 0.72, green: 0.88, blue: 0.98)], startPoint: .top, endPoint: .bottom)
        case .autumn: return LinearGradient(colors: [Color(red: 1.00, green: 0.93, blue: 0.82), Color(red: 0.97, green: 0.84, blue: 0.68)], startPoint: .top, endPoint: .bottom)
        case .winter: return LinearGradient(colors: [Color(red: 0.93, green: 0.96, blue: 1.00), Color(red: 0.85, green: 0.91, blue: 0.98)], startPoint: .top, endPoint: .bottom)
        }
    }
